...
const ClientTrackProject = () => {
    ...
    if (projects.length === 0) return (
        <div style={{ textAlign: "center", padding: "80px 40px", background: "rgba(15,23,42,0.4)", borderRadius: "20px", border: "1px dashed rgba(255,255,255,0.1)" }}>
            <LayoutDashboard size={48} color="#334155" style={{ margin: "0 auto 20px" }} />
            <p style={{ fontWeight: 700, color: "#94a3b8", fontSize: "18px" }}>{t('no_active_projects') || "No active projects found."}</p>
            <p style={{ color: "#475569", fontSize: "14px" }}>{t('no_active_projects_sub') || "Once your project starts, you can track milestones and progress here."}</p>
        </div>
    );
                            ...
                            >
                                <div style={{ flex: 1, minWidth: 0 }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
                                        <h3 style={{ margin: 0, fontSize: "18px", fontWeight: 800, color: "white" }}>{project.name}</h3>
                                        <span style={{ 
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                                        <div style={{ flex: 1, maxWidth: "240px", height: "6px", background: "rgba(255,255,255,0.05)", borderRadius: "10px", overflow: "hidden" }}>
                                ...
                                <div style={{ padding: "0 24px 24px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
                                    <div style={{ padding: "24px 0" }}>
                                        ...
                                        {(!project.progress || project.progress.length === 0) ? (
                                            <p style={{ color: "#475569", fontSize: "14px", fontStyle: "italic" }}>No milestones recorded yet.</p>
                                        ) : (
                                            <div style={{ position: "relative", paddingLeft: "32px", borderLeft: "2px solid rgba(255,255,255,0.05)" }}>
                                                    ...
                                                    return (
                                                        <div key={idx} style={{ position: "relative", marginBottom: "32px" }}>
                                                            ...
                                                            <div style={{
                                                                ...
                                                                background: sc.dot, border: "4px solid #0f172a",
                                                            ...
                                                            <div style={{
                                                                ...
                                                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
                                                                    <h5 style={{ margin: 0, fontSize: "16px", fontWeight: 700, color: "white" }}>{ms.title}</h5>
                                                                    <span style={{ 
                                                                ...
                                                                <p style={{ margin: "0 0 16px", fontSize: "14px", color: "#94a3b8", lineHeight: 1.6 }}>{ms.description}</p>
