...
import { Building2, LogOut, Mail, Phone, X, Shield, Sparkles, Home, Globe } from "lucide-react";
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#070d1a", fontFamily: "'Inter', sans-serif" }}>
            ...
            <style>{`
                ...
                .cdl-hero-divider { width:1px; height:32px; background:rgba(255,255,255,0.15); flex-shrink:0; }
            `}</style>
            ...
            <div style={{
                ...
                {/* Decorative orbs */}
                <div style={{ position:"absolute", top:"-60px", right:"-60px", width:"320px", height:"320px", borderRadius:"50%", background:"radial-gradient(circle, rgba(59,130,246,0.15) 0%, transparent 70%)", pointerEvents:"none" }} />
                <div style={{ position:"absolute", bottom:"-80px", left:"5%",   width:"280px", height:"280px", borderRadius:"50%", background:"radial-gradient(circle, rgba(139,92,246,0.12) 0%, transparent 70%)", pointerEvents:"none" }} />
                {/* Grid overlay */}
                ...
                <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative" }}>
                    ...
                    <h1 style={{ margin: "0 0 10px", fontSize: "30px", fontWeight: 900, color: "white", letterSpacing: "-.02em" }}>
                        {t('my_project_requests')}
                    </h1>
            ...
            {/* ── MAIN CONTENT ── */}
            <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "32px 28px 64px", position: "relative", zIndex: 1 }}>
                <RequestNewProject />
                <UploadAgreement uploadedByRole="client" uploadedByName={clientName} />
            </main>
        </div>
    );
}
