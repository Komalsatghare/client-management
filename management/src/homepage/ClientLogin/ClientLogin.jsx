    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                // Also store user info for the dashboard
            ...
            <div className="login-container">
                <div className="login-card">
                    <div className="login-header">
                        ...
                        <h2 className="login-title">Client Portal</h2>
                        <p className="login-subtitle">
                            Log in to track your projects and payments
                        </p>
                    </div>
                        ...
                        <div className="input-group">
                            ...
                            <div style={{ textAlign: "right", marginTop: "6px" }}>
                                <button
                                    ...
                                    style={{ background: "none", border: "none", color: "#60a5fa", cursor: "pointer", fontSize: "13px", fontWeight: 600, padding: 0 }}
                                >
                                    Forgot Password?
                                </button>
                            </div>
                    ...
                    <div style={{ marginTop: "2rem", textAlign: "center", fontSize: "0.875rem", color: "#94a3b8" }}>
                        ...
                        <Link to="/client-signup" style={{ color: "#60a5fa", textDecoration: "none", fontWeight: 600 }}>
                            Client Sign Up
                        </Link>
                    </div>
                </div>
