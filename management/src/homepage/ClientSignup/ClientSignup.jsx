    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                localStorage.setItem("clientPhone", formData.phone || '');
            ...
            <div className="signup-container">
                <div className="signup-card">
                    <div className="signup-header">
                        ...
                        <h2 className="signup-title">Client Registration</h2>
                        <p className="signup-subtitle">
                            Create a portal account to track your projects & payments
                        </p>
                    </div>
